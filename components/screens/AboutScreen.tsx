...
export default function AboutScreen({ navigate: _navigate }: Props) {
  useReveal();
    ...
    <div className="about fade-in">
      ...
      <section className="about-contact reveal">
        <div className="contact-grid">
          ...
          <form className={`contact-form${shaking ? ' shake' : ''}`} onSubmit={onSubmit}>
            {!sent ? (
              <>
                <div className="field">
                  <label>NOMBRE</label>
                ...
                {error && (
                  <p style={{ color: 'var(--magenta)', fontFamily: 'var(--mono)', fontSize: 12, margin: '0 0 12px' }}>
                    ⚠ {error}
                  </p>
                )}
                <button
